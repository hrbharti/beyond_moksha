      ...
      <section className="w-full bg-white text-[#1F3A52] relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 lg:px-12 pt-24 pb-32 grid grid-cols-1 md:grid-cols-2 items-center gap-12">
          ...
          <div className="relative md:ml-auto flex justify-center md:justify-end">
            ...
            <div aria-hidden className="absolute inset-0 rounded-[150px] ring-1 ring-[#D7D7D7] -translate-x-[8px] -translate-y-[8px] hidden md:block" />
            <div aria-hidden className="absolute inset-0 rounded-[150px] ring-1 ring-[#D1B26F] translate-x-[8px] translate-y-[8px] hidden md:block" />
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-12 max-w-6xl mx-auto px-4 mt-10">
            ...
            <div className=" items-center justify-center w-full md:w-[45%] hidden lg:flex">
              <div className="w-full md:w-[350px]">
                <Image src={'/mark.png'} alt="markpng" width={350} height={350} className="w-full h-auto"/>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
            <div className="bg-[#D8EDFF] rounded-xl shadow-lg px-8 py-12 inset-shadow-sm">
              ...
              <p className="text-center text-[#1F3A52]">We listen, we care, we walk beside you.</p>
            </div>
            ...
            <div className="bg-[#2471B6] rounded-xl shadow-lg px-8 py-12 inset-shadow-sm">
              ...
              <p className="text-center text-white">Every life is sacred. Every farewell is graceful.</p>
            </div>
            ...
            <div className="bg-[#0B4975] rounded-xl shadow-lg px-8 py-12 inset-shadow-sm">
              ...
              <p className="text-center text-white">Clear answers, honest costs, complete trust.</p>
            </div>
            ...
            <div className="bg-[#D8EDFF] rounded-xl shadow-lg px-8 py-12 inset-shadow-sm">
              ...
              <p className="text-center text-[#1F3A52]">Trained, calm, and precise in every service.</p>
            </div>
          </div>
        </div>
      </section>
