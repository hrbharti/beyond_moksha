      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-wrap items-center gap-6 text-lg mt-10 justify-center md:justify-start">
          ...
          <Icon
            ...
            onClick={() =>
              window.open(
                "https://x.com/beyondmoksha360?t=D9sL0243Mb32RhXAy-vZ2A&s=09",
                "_blank",
              )
            }
          />
          <Icon
            ...
            onClick={() =>
              window.open(
                "https://www.instagram.com/beyondmoksha360?igsh=MWNhMHdhYzlnbzRhaw==",
                "_blank",
              )
            }
          />
          ...
          <Icon
            ...
            onClick={() =>
              window.open(
                "https://youtube.com/@beyondmoksha360?si=s5YThsuU4FPCRwz4",
                "_blank",
              )
            }
          />
