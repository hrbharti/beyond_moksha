// app/components/PanditAstrologerForm.tsx
'use client'
    ...
    >
      ...
      <div className="space-y-1 text-center md:text-left">
        ...
        <p className="text-sm text-gray-500">
          Apply to receive verified bookings with flexible schedules and prompt support.
        </p>
      </div>
      ...
      <section className="space-y-4">
        ...
        <div>
          <p className="text-sm text-gray-700 mb-1">
            Specialization * <span className="text-xs text-gray-500">(Select all that apply)</span>
          </p>
          <CheckboxGroup
        ...
        <div>
          <p className="text-sm text-gray-700 mb-1">
            Languages Known * <span className="text-xs text-gray-500">(Select all that apply)</span>
          </p>
          <CheckboxGroup
            name="languages"
            options={LANGUAGES}
      ...
      <section className="space-y-4">
        <h2 className="font-medium text-gray-800">Location &amp; Availability</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <label className="block">
            ...
            {errors.experience && (
              <p className="text-xs text-red-500 mt-1">Experience is required.</p>
            )}
          </label>

          <label className="block">
            <div className="flex items-center justify-between mb-1">
              <span className="text-sm text-gray-600">Typical Fee per Puja (₹)</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <label className="block">
            <div className="text-sm text-gray-600 mb-1">Upload Photo/Certificates</div>
            <input
              type="file"
              multiple
              {...register('photos')}
      ...
      <div className="pt-2 space-y-2">
        <label className="flex items-start gap-3 text-sm text-gray-700">
          ...
          />
          <span>
            I agree to Beyond Moksha&apos;s partner terms and conditions, and confirm that all
