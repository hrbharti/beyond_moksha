...
export default function Logo({isNav}:NavProps){
    ...
    return <div className="w-[340px] h-[58px] cursor-pointer flex items-center">
                ...
                <div className="h-full w-17"><Image src={bird} alt="Beyond-moksha image" /></div>
                <div className="h-full ">
                    <div className={`text-4xl mt-3  `}>
                        <span className={`${isNav ? "text-[#1F3A52] text-gradient-to-t from-[#1F3A52] to-[#4682B8]" : "text-[rgba(104,85,61,1)] text-gradient-to-r from-[rgba(104,85,61,1)] to-[rgba(0,0,0,1)] to-[55%]"}`}>
                            Beyond
                        </span> 
