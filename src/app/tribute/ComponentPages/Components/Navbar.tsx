      ...
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 -mt-1">Tag line for beyond moksha</p>
          </div>
        </div>

        {/* Desktop Menu */}
        <div className="hidden md:flex space-x-8 text-[#1F3A4B] font-medium">
          <a href="#" className="hover:text-[#D4A043] transition">Memorial</a>
          <a href="#" className="hover:text-[#D4A043] transition">Gallery</a>
          <a href="#" className="hover:text-[#D4A043] transition">Memory Wall</a>
